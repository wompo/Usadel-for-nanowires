subroutine mysub(Y, Yout, alpha_1, alpha_2, alpha_3, alpha_4, h, h_angle, omega)
    implicit none

    real, parameter :: PI = 3.1415926
    double precision, intent(in) :: alpha_1, alpha_2, alpha_3, alpha_4, h, h_angle, omega
    ...
    rhs = 2*omega*MATMUL(s0,g)& ! This is the energy term. 1st on the RHS.
